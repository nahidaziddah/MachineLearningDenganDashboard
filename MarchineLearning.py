...
# ---------------------------------------------------------
# 0. DATA DEFAULT (DIPAKAI JIKA USER TIDAK UPLOAD)
# ---------------------------------------------------------
def load_default_data():
    # Contoh data 5 tahun (60 bulan)
...
# STREAMLIT UI
# ---------------------------------------------------------
st.title("🌦️ Prediksi Iklim Indonesia dengan Machine Learning")
st.write("Anda dapat upload data sendiri atau memakai data default.")
...
if uploaded_file:
    ...
    st.info("📌 Tidak ada file diupload — menggunakan **data default otomatis**.")
